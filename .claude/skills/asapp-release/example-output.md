...
[Step 4] Dropping released TODO section for 0.3.0...  done (committed)
...
[Step 7] Archiving design specs...  done (4 specs → docs/superpowers/specs/v0.3.0/)
[Step 8] Building and testing...  done (BUILD SUCCESS — local pre-flight; full build/publish run in CI after push)
[Step 9] Committing release and tagging...  done (tag: v0.3.0)
[Step 10] Bumping to next SNAPSHOT...
  - pom.xml → 0.4.0-SNAPSHOT
  - OpenAPI version → 0.4.0-SNAPSHOT (3 services)
  - docker-compose.yml → 0.4.0-SNAPSHOT (5 services)
[Step 11] Committing next dev version...  done

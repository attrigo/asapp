...
- Don't hardcode `src/main/...` — `**` matches through it anyway. Add it only when the same path also exists under `target/`/`build/` and must be excluded (`mapping.md`, `liquibase.md`, `configuration.md`).

...
package com.attrigo.asapp.url.authentication;

/**
 * Defines the paths for authentication endpoints of authentication service.
 *
 * @since 0.2.0
 * @author attrigo
 */
public class AuthenticationRestAPIURL {
    ...
    private AuthenticationRestAPIURL() {}

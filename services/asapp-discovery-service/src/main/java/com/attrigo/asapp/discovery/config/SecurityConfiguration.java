...
import com.attrigo.asapp.discovery.security.web.HttpBasicAuthenticationEntryPoint;
...
public class SecurityConfiguration {
     ...
     * <ul>
     * <li>Disables CSRF: authentication is stateless (HTTP Basic header); no session cookies exist to hijack.</li>
     ...
     * Applies the following configurations to the filter chain:
     * <ul>
     * <li>Disables CSRF: authentication is stateless (HTTP Basic header); Eureka client registrations (POST to {@literal /eureka/apps/**}) would be blocked by
     * CSRF protection.</li>

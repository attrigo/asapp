...
public class JwtTokenProvider {
     ...
     *
     * @param token the JWT token, must not be {@literal null}.
    ...
    /**
     * Extracts the list of authorities (roles) from the provided JWT token.
     *
     * @param token the JWT token, must not be {@literal null}.
    ...
    /**
     * Validates the provided JWT token by checking its signature.
     *

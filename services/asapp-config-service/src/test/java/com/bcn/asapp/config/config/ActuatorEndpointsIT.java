 ...
 * <li>Liveness probe endpoint is accessible with and without credentials</li>
 * <li>Readiness probe endpoint is accessible with and without credentials</li>
 */
...
class ActuatorEndpointsIT {
    ...
    @Test
    void ReturnsStatusOk_OnLivezEndpointWithoutCredentials() {
        // When & Then
        restTestClient.get()
                      .uri("/livez")
                      .exchange()
    ...
    @Test
    void ReturnsStatusOk_OnLivezEndpointWithCredentials() {
        // When & Then
        restTestClient.get()
                      .uri("/livez")
                      .headers(h -> h.setBasicAuth(configUsername, configPassword))
    ...
    @Test
    void ReturnsStatusOk_OnReadyzEndpointWithoutCredentials() {
        // When & Then
        restTestClient.get()
                      .uri("/readyz")
                      .exchange()
    ...
    @Test
    void ReturnsStatusOk_OnReadyzEndpointWithCredentials() {
        // When & Then
        restTestClient.get()
                      .uri("/readyz")
                      .headers(h -> h.setBasicAuth(configUsername, configPassword))

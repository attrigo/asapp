...
class DecodedTokenTests {
    ...
    private final String roleClaim = USER.name();

    private final Map<String, Object> accessTokenClaims = Map.of(TOKEN_USE, ACCESS_TOKEN_USE, ROLE, roleClaim);

    private final Map<String, Object> refreshTokenClaims = Map.of(TOKEN_USE, REFRESH_TOKEN_USE, ROLE, roleClaim);
    ...
    class CreateDecodedToken {
        ...
        void ThenThrowsIllegalArgumentException_GivenEncodedTokenIsNull(String encodedToken) {
            // When
            var thrown = catchThrowable(() -> new DecodedToken(encodedToken, ACCESS_TOKEN_TYPE, subject, accessTokenClaims));
        ...
        void ThenThrowsIllegalArgumentException_GivenTypeIsNull(String type) {
            // When
            var thrown = catchThrowable(() -> new DecodedToken(encodedToken, type, subject, accessTokenClaims));
        ...
        void ThenCreatesDecodedToken_GivenAllParametersAreValid() {
            // When
            var actual = new DecodedToken(encodedToken, ACCESS_TOKEN_TYPE, subject, accessTokenClaims);
    ...
    class CheckIsAccessToken {
        ...
        void ThenReturnsFalse_GivenTypeIsNotAccessToken() {
            // Given
            var decodedToken = new DecodedToken(encodedToken, REFRESH_TOKEN_TYPE, subject, accessTokenClaims);
        ...
        void ThenReturnsTrue_GivenTypeAndTokenUseClaimAreAccessToken() {
            // Given
            var decodedToken = new DecodedToken(encodedToken, ACCESS_TOKEN_TYPE, subject, accessTokenClaims);
    ...
    class CheckIsRefreshToken {
        ...
        void ThenReturnsFalse_GivenTypeIsNotRefreshToken() {
            ...
            // When
            var actual = decodedToken.isRefreshToken();
        ...
        void ThenReturnsFalse_GivenTypeIsRefreshTokenButTokenUseClaimIsAccess() {
            ...
            var decodedToken = new DecodedToken(encodedToken, REFRESH_TOKEN_TYPE, subject, mixedClaims);
        ...
        void ThenReturnsTrue_GivenTypeAndTokenUseClaimAreRefreshToken() {
            // Given
            var decodedToken = new DecodedToken(encodedToken, REFRESH_TOKEN_TYPE, subject, refreshTokenClaims);

...
class PasswordEncoderIT {
    ...
    class AuthenticateWithUserPassword {
        ...
        @Test
        void AuthenticatesUserAndReturnsStatusOkAndBodyWithGeneratedAuthentication_BcryptEncodedStoredUserPassword() {
            // Given
        ...
        @Test
        void AuthenticatesUserAndReturnsStatusOkAndBodyWithGeneratedAuthentication_Argon2EncodedStoredUserPassword() {
            // Given
        ...
        @Test
        void AuthenticatesUserAndReturnsStatusOkAndBodyWithGeneratedAuthentication_Pbkdf2EncodedStoredUserPassword() {
            // Given
        ...
        @Test
        void AuthenticatesUserAndReturnsStatusOkAndBodyWithGeneratedAuthentication_ScryptEncodedStoredUserPassword() {
            // Given
        ...
        @Test
        void AuthenticatesUserAndReturnsStatusOkAndBodyWithGeneratedAuthentication_NoopEncodedStoredUserPassword() {
            // Given

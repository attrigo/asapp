 ...
 * <p>
 * Coverage:
 * <li>Generates API documentation snippets for all authentication endpoints</li>
 ...
 */
class AuthenticationRestControllerDocIT extends RestDocsWebMvcTestContext {
            ...
            mockMvc.perform(post(AUTH_REFRESH_TOKEN_FULL_PATH).contentType(APPLICATION_JSON)
                   ...
                   // @formatter:off
                       document("refresh-authentication",
                           requestFields(
                                   fieldWithPath("refresh_token").description("The refresh token to renew the session")
                           ),
                           responseFields(
            ...
            mockMvc.perform(post(AUTH_REVOKE_FULL_PATH).contentType(APPLICATION_JSON)
                   ...
                   // @formatter:off
                       document("revoke-authentication",
                           requestFields(
                                   fieldWithPath("access_token").description("The access token identifying the session to revoke")
                           )
                       )
                       // @formatter:on
                   );

...
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.DEFAULT_ACCESS_TOKEN_CLAIMS;
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.DEFAULT_REFRESH_TOKEN_CLAIMS;
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.DEFAULT_SUBJECT;
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.EXPIRATION_TIME_MILLIS;
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.TOKEN_EXPIRED_OFFSET_MILLIS;
import static com.bcn.asapp.authentication.testutil.TestFactoryConstants.generateRandomIssueAt;
...
public final class JwtAuthenticationFactory {
    ...
    public static JwtAuthentication authenticatedJwtAuth() {
        return aJwtAuthenticationBuilder().build();
    }

    public static JwtAuthentication unauthenticatedJwtAuth() {
        return aJwtAuthenticationBuilder().withAuthenticationId(null)
                                          .build();
    }

    public static JwtAuthentication aJwtAuthentication() {
        return aJwtAuthenticationBuilder().build();
    }

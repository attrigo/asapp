...
class OpenApiEndpointsIT {
    ...
    void ReturnsStatusOkAndBodyExposesOnlyBusinessOperations_OnOpenApiDocs() {
        ...
        assertThatJson(actual).node("paths")
                              .isObject()
                              .containsOnlyKeys(AUTH_TOKEN_FULL_PATH, AUTH_REFRESH_TOKEN_FULL_PATH, AUTH_REVOKE_FULL_PATH, USERS_GET_ALL_FULL_PATH,
                                      USERS_GET_BY_ID_FULL_PATH);
        assertThatJson(actual).node("paths")
                              .node(AUTH_TOKEN_FULL_PATH)
                              .isObject()
                              .containsOnlyKeys("post");
        assertThatJson(actual).node("paths")
                              .node(AUTH_REFRESH_TOKEN_FULL_PATH)
                              .isObject()
                              .containsOnlyKeys("post");
        assertThatJson(actual).node("paths")
                              .node(AUTH_REVOKE_FULL_PATH)
                              .isObject()
                              .containsOnlyKeys("post");
        assertThatJson(actual).node("paths")
        ...
        assertThatJson(actual).node("paths")
                              .node(USERS_GET_BY_ID_FULL_PATH)
                              .isObject()

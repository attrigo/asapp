...
package com.attrigo.asapp.authentication.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.attrigo.asapp.authentication", importOptions = ImportOption.DoNotIncludeTests.class)
class LayerDependencyRulesTests {
    ...
    // @formatter:off
            noClasses().that()
                       .resideInAPackage("com.attrigo.asapp.authentication")
                       .should()
                       .dependOnClassesThat()
    ...
    // @formatter:off
            classes().that()
                     ...
                     .should()
                     .onlyHaveDependentClassesThat()
                     .resideInAnyPackage("..infrastructure..", "com.attrigo.asapp.authentication");
    // @formatter:on

...
package com.attrigo.asapp.authentication.domain.user;
...
class UsernameTests {
    ...
    class CreateUsernameWithConstructor {
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.authentication.domain.user.UsernameTests#provideValidUsernames")
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.authentication.domain.user.UsernameTests#provideInvalidUsernames")

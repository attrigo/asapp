...
public interface TokenVerifier {
     ...
     * @return the {@link DecodedJwt} containing validated token information
     ...
     */
    DecodedJwt verifyAccessToken(EncodedToken encodedToken);
     ...
     * @throws AuthenticationNotFoundException if the authentication session is not found
     */
    DecodedJwt verifyRefreshToken(EncodedToken encodedToken);

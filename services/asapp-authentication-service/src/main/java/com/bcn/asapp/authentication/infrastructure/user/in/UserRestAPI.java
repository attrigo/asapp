...
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_CREATE_PATH;
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_DELETE_BY_ID_PATH;
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_GET_ALL_PATH;
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_GET_BY_ID_PATH;
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_ROOT_PATH;
import static com.bcn.asapp.url.authentication.UserRestAPIURL.USERS_UPDATE_BY_ID_PATH;
...
public interface UserRestAPI {
     ...
     * <li>401-UNAUTHORIZED: Authentication required or failed.</li>
     * <li>404-NOT_FOUND: User not found.</li>
     * <li>500-INTERNAL_SERVER_ERROR: An internal error occurred during user deletion or compensation failure.</li>
    ...
    @SecurityRequirement(name = "Bearer Authentication")
    @Operation(summary = "Deletes a user by their unique identifier", description = "Removes a user from the system by their unique identifier. This endpoint requires authentication. Removes user's authentications before deletion. This operation cannot be undone.")
    ...
    @ApiResponse(responseCode = "401", description = "Authentication required or failed", content = {
            @Content(schema = @Schema(implementation = ProblemDetail.class)) })
    @ApiResponse(responseCode = "404", description = "User not found", content = { @Content })
    @ApiResponse(responseCode = "500", description = "An internal error occurred during user deletion or compensation failure", content = {
            @Content(schema = @Schema(implementation = ProblemDetail.class)) })

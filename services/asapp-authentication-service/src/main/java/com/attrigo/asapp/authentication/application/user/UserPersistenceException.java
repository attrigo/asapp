...
package com.attrigo.asapp.authentication.application.user;
 ...
 * <p>
 * This domain-specific exception extends the generic {@link PersistenceException} to provide user context while maintaining the ability to catch all
 ...
 * @author attrigo
 */
public class UserPersistenceException extends PersistenceException {

    /**
     * Constructs a new {@code UserPersistenceException} with the specified detail message and cause.
     *

...
@Import(JwtRevokerAdapter.class)
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@Testcontainers(disabledWithoutDocker = true)
@Transactional(propagation = Propagation.NEVER)
class JwtRevokerAdapterIT {
    ...
    @Autowired
    private JwtRevokerAdapter jwtRevokerAdapter;
    ...
    class RevokeAuthenticationByAuthentication {
        ...
        void UserNotExists_RevokeAuthentication_DoesNotRevokeAuthenticationAndThrowsUsernameNotFoundException() {
            ...
            Executable executable = () -> jwtRevokerAdapter.revokeAuthentication(authentication);
        ...
        void UserHasNotAccessToken_RevokeAuthentication_RevokesAccessToken() {
            ...
            jwtRevokerAdapter.revokeAuthentication(authentication);
    ...
    class RevokeAuthenticationByUser {
        ...
        void UserHasNotAccessToken_RevokeAuthentication_RevokesAccessToken() {
            ...
            // When
            jwtRevokerAdapter.revokeAuthentication(fakeUserSaved);
        ...
        void AccessTokenCouldNotBeRevoked_RevokeAuthentication_DoesNotRevokeAuthenticationAndThrowsJwtIntegrityViolationException() {
            ...
            try {
                // When
                Executable executable = () -> jwtRevokerAdapter.revokeAuthentication(fakeUserSaved);

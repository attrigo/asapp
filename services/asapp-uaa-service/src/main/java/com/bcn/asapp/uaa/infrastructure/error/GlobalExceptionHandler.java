...
package com.bcn.asapp.uaa.infrastructure.error;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Maps the invalid request fields ({@link FieldError}) to a more specific DTO {@link InvalidRequestParameter}.
     *
     * @param fieldErrors the list of invalid fields to map
     * @return a list of {@link InvalidRequestParameter} that contains the invalid fields
     */

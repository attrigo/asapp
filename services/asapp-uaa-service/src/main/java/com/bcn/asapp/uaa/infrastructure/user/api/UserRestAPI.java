...
public interface UserRestAPI {
    ...
    ResponseEntity<GetUserByIdResponse> getUserById(@PathVariable("id") @Parameter(description = "Id of the user to get") UUID id);
     ...
     * <p>
     * Creates a new request with a new generated id, any provided id will be ignored.
     * <p>
     * Response codes:
     * <ul>
     ...
     * <p>
     * Updates the data of an existing request by id except the id, with the provided new data.
     * <p>
     * Response codes:
     * <ul>
    ...
    @ApiResponse(responseCode = "401", description = "Authentication required or failed", content = { @Content })
    @ApiResponse(responseCode = "404", description = "User not found", content = { @Content })
    ResponseEntity<UpdateUserResponse> updateUserById(@PathVariable("id") @Parameter(description = "Id of the request to update") UUID id,

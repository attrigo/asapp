...
public class AuthenticateUserService implements AuthenticateUserUseCase {
    ...
    public AuthenticateUserService(JwtAuthenticationManager authenticationManager, JwtIssuer jwtIssuer) {
    ...
    public JwtAuthentication authenticate(String username, String password) {
        var authentication = authenticationManager.authenticate(username, password);

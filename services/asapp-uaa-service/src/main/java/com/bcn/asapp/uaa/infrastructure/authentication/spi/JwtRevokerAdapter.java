 ...
 */
@Component
public class JwtRevokerAdapter {
    ...
    /**
     * Constructs a new {@link JwtRevokerAdapter} with the specified dependencies.
     *
     ...
     */
    public JwtRevokerAdapter(UserRepository userRepository, AccessTokenRepository accessTokenRepository, RefreshTokenRepository refreshTokenRepository) {

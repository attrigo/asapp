...
package com.bcn.asapp.uaa.infrastructure.user.in;
...
import com.bcn.asapp.uaa.infrastructure.user.in.request.CreateUserRequest;
import com.bcn.asapp.uaa.infrastructure.user.in.request.UpdateUserRequest;
import com.bcn.asapp.uaa.infrastructure.user.in.response.CreateUserResponse;
import com.bcn.asapp.uaa.infrastructure.user.in.response.GetAllUsersResponse;
import com.bcn.asapp.uaa.infrastructure.user.in.response.GetUserByIdResponse;
import com.bcn.asapp.uaa.infrastructure.user.in.response.UpdateUserResponse;

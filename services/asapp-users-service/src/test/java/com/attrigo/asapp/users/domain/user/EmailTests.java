...
class EmailTests {
    ...
    class CreateEmailWithConstructor {
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.users.domain.user.EmailTests#provideValidEmails")
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.users.domain.user.EmailTests#provideInvalidEmails")

...
package com.attrigo.asapp.users.domain.user;
...
class PhoneNumberTests {
    ...
    class CreatePhoneNumberWithConstructor {
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.users.domain.user.PhoneNumberTests#provideValidPhoneNumbers")
        ...
        @ParameterizedTest
        @MethodSource("com.attrigo.asapp.users.domain.user.PhoneNumberTests#provideInvalidPhoneNumbers")

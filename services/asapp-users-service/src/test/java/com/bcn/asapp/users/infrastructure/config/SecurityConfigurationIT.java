...
import static com.bcn.asapp.users.testutil.EncodedTokenFactory.anEncodedTokenBuilder;
import static com.bcn.asapp.users.testutil.EncodedTokenFactory.encodedAccessToken;
import static com.bcn.asapp.users.testutil.EncodedTokenFactory.encodedRefreshToken;
...
class SecurityConfigurationIT {
    ...
    class HttpBasicAuthentication {
        ...
        @Test
        void ReturnsStatusUnauthorizedAndEmptyBody_AuthorizationHeaderMissingInRequest() {
            // When & Then
            webTestClient.get()
                         .uri("/actuator")
                         .exchange()
